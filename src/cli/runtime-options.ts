/**
 * CLI Runtime Options Module
 *
 * This module defines CLI-specific runtime options that control the behavior
 * of the Milhouse CLI during execution. These options are parsed from
 * command-line arguments and are separate from the persisted configuration.
 *
 * @module cli/runtime-options
 * @since 5.0.0
 */
